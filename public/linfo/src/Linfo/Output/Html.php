...
<head>
	...
	<link href="./linfo/layout/favicon.ico" type="image/x-icon" rel="shortcut icon">
	<link id="themeCssLink" href="./linfo/layout/theme_'.$chosen_theme.'.css" rel="stylesheet">'.($show_icons ? '
	<link href="./linfo/layout/icons.css" rel="stylesheet">' : ''
    ).'
	<script src="./linfo/layout/scripts.min.js"></script>
	<meta name="generator" content="'.$appName.' ('.$version.')">
	<meta name="author" content="Joseph Gillotti &amp; friends">
	<!--[if lt IE 8]>
	<link href="./linfo/layout/old_ie.css" type="text/css" rel="stylesheet">
	<![endif]-->
	<link rel="stylesheet" type="text/css" href="./linfo/layout/mobile.css" media="screen and (max-width: 640px)">
</head>
<body id="info">
<div id="header">';
